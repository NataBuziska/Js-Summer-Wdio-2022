...
class Homepage {
    ...
    previousMonthButtonLocator = '*[aria-label="Previous month"]'
    currentDate = "//td[contais(@class,'startSelected')]//button"
    ...
    async clickOnPreviousMonthButton() {
        await this.commands.clickWebElement(this.previousMonthButtonLocator);
        await browser.pause(1000);
    }
    async findCurrentDateButton() {
        await this.commands.clickWebElement(this.currentDate);
        await browser.pause(1000);
    }
}
